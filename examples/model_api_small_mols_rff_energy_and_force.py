"""
High-level model API — LocalRFFModel, energy+force training on small molecules.
...
Demonstrates energy_and_force training using pre-split train/test sets:
  ...
  2. Fit LocalRFFModel on atomization energies + forces
...
Usage:
    uv run python examples/model_api_small_mols_rff_energy_and_force.py
"""
...
# ---------------------------------------------------------------------------
print("=" * 60)
print("LocalRFFModel — energy+force training on small molecules")
print("=" * 60)
...
# ---------------------------------------------------------------------------
t0 = time.perf_counter()
model = LocalRFFModel(sigma=SIGMA, l2=L2, d_rff=D_RFF, seed=SEED, elements=ELEMENTS)
...
# # Save and reload
# # ---------------------------------------------------------------------------
# save_path = "/tmp/small_mols_rff_model.npz"
# model.save(save_path)
# print(f"\n[5] Model saved to {save_path}")
# 
# loaded = LocalRFFModel.load(save_path)
