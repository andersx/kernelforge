"""Geometry optimisation of rMD17 aspirin using CudaLocalRFFModel.

This script:
  1. Downloads/loads the rMD17 aspirin dataset (cached under ~/.kernelforge/).
  2. Fits a CudaLocalRFFModel (D=16384, no PCA) on 950 training frames.
...
Usage
-----
    uv run --env-file /dev/null python examples/run_opt_rmd17_aspirin_rff.py
"""
...
MAX_STEPS     = 500
TRAJ_OUT      = Path("aspirin_rff_opt.extxyz")
LOG_OUT       = Path("aspirin_rff_opt.log")
