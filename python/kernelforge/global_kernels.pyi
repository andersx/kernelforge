...
def kernel_gaussian_symm(X: NDArray[np.float64], sigma: float) -> NDArray[np.float64]: ...
def kernel_gaussian_symm_rfp(X: NDArray[np.float64], sigma: float) -> NDArray[np.float64]: ...
def kernel_gaussian(
