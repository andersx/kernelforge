...
def print_header(suite_name: str) -> None:
    ...
    print()
    print("╔" + "=" * 78 + "╗")
    print(f"║ {PROGRAM_NAME} v{__version__:<64} ║")
    print("╠" + "=" * 78 + "╣")
    print(f"║ Python:      {info['python']:<59} ║")
    print(f"║ Platform:    {info['platform']:<59} ║")
    print(f"║ CPU:         {info['cpu']:<59} ║")
    print(f"║ Hostname:    {info['hostname']:<59} ║")
    print(f"║ Timestamp:   {info['timestamp']:<59} ║")
    print("╠" + "=" * 78 + "╣")
    print(f"║ Suite:       {suite_name:<59} ║")
    print("╠" + "=" * 78 + "╣")
    print()
