...
`manylinux_cuda` images. Release wheels currently target **CPython 3.14** only.
Not necessarily on PyPI yet — claim the project and Trusted Publisher before
the first upload. Until then, build locally:
