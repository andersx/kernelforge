...
void generate_fchl_acsf(const std::vector<double>& coords,
...
void flocal_kernel_fast(
    const double* x1, const int* q1, const int* n1,
    int nm1, int max_n1,
    const double* x2, const int* q2, const int* n2,
    int nm2, int max_n2,
